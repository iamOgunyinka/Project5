...
jjgames_proxy::jjgames_proxy(net::io_context &io /*, global_proxy_repo_t &r*/)
    : proxy_base{io, /*r, */ proxy_filename} {
  target_ =
      R"(/api/ip?app_key=86adb80a7af9ee8d31bf765dd02e1431&pack=210115&num=100&xy=3&type=1&lb=\n&port=3&mr=1&)";
...
generic_proxy::generic_proxy(
  ...
  target_ =
      (R"(/api/ip?app_key=19ead3cb7a5d477f5d480d850f18de94&pack=210602&num=100&xy=1&type=1&lb=\n&mr=1&)");
  //"/getip?num=20&type=1&pro=&city=0&yys=0&port=2&time=2&ts=0&ys=0&cs=0&lb="
  //"4&sb=0&pb=45&mr=1&regions=";
  host_ = "http://api.wandoudl.com/api/ip";
  // host_ = "webapi.http.zhimacangku.com";
  //verify_extract_ = true;
  count_path_ = R"(/api/product/list?app_key=19ead3cb7a5d477f5d480d850f18de94)";
  load_proxy_file();
}

// http://webapi.http.zhimacangku.com
