...
void macau_baccarat_http_socket_t::prepare_request_data(
...
void macau_baccarat_http_socket_t::data_received(beast::error_code ec,
                                                 std::size_t const) {
  if (ec) {
...
void macau_baccarat_socks5_socket_t::prepare_request_data(
    bool use_authentication_header) {
  using http::field;
  using http::verb;
...
void macau_baccarat_socks5_socket_t::data_received(beast::error_code ec,
                                                   std::size_t const) {
