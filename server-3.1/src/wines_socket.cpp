...
void wines_http_socket_t::prepare_request_data(bool use_authentication_header) {
...
void wines_http_socket_t::data_received(beast::error_code ec,
                                        std::size_t const) {
  if (ec) {
...
void wines_socks5_socket_t::prepare_request_data(
...
void wines_socks5_socket_t::data_received(beast::error_code ec,
                                          std::size_t const) {
  if (ec) {
    if (ec != beast::http::error::end_of_stream) {
      this->current_proxy_assign_prop(
