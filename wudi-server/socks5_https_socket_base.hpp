...
public:
  socks5_https_socket_base_t(bool &stopped, net::io_context &, Proxy &,
...
template <typename Derived, typename Proxy>
void socks5_https_socket_base_t<Derived, Proxy>::retry_first_handshake() {
  ++handshake_retries_;
...
template <typename Derived, typename Proxy>
void socks5_https_socket_base_t<Derived, Proxy>::retry_second_handshake() {
...
void socks5_https_socket_base_t<Derived,
                                Proxy>::perform_sock5_second_handshake() {
